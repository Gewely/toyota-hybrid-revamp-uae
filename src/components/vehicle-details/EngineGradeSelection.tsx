...
import { Info, Star, Check, Wrench, Car as CarIcon, ChevronDown, ArrowRight, Cube } from "lucide-react";
import type { VehicleModel } from "@/types/vehicle";
import VehicleGradeComparison from "./VehicleGradeComparison";

/* =========================================================
   Luxury Light v7 — "Showroom Porcelain" (No Dark Mode)
   - Hero inspired by screenshot: big left typography + bright CTA,
     right-anchored glossy car poster, LIGHT background.
   - Desktop: 7/5 layout (grid of GradeTiles + decision panel)
   - Mobile: poster-style carousel + compact decision panel (accordions)
   - No sticky anywhere. Reduced red; bright accent for CTAs.
========================================================= */
...
function track(_e: string, _p?: Record<string, unknown>) {
  ...
  return (
    <section className="relative bg-gradient-to-b from-white via-zinc-50 to-white">
      <div className="mx-auto w-full max-w-[1400px] px-4 sm:px-6 md:px-8">
        {/* HERO — light, screenshot-inspired */}
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-10 items-center py-10 sm:py-14 md:py-18">
          {/* left copy */}
          <div className="lg:col-span-6">
            ...
            <div className="mt-8">
              ...
              <div className="mt-2 flex items-center gap-2 text-xs text-zinc-600">
                ...
                <span>Figures are illustrative; WLTP/NEDC equivalents may vary.</span>
              </div>
            </div>
          </div>
        ...
        <div ref={gradesRef} className="py-8 sm:py-10">
          {/* Desktop */}
...
/* Compact mobile collapsible with light theme */
