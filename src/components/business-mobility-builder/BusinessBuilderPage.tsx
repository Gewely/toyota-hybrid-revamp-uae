      ...
      <div className="relative overflow-hidden rounded-[2.5rem] bg-gradient-to-br from-gray-950 via-gray-900 to-red-950 p-8 text-white shadow-2xl md:p-12">
        ...
        <div className="relative">
          <div className="flex flex-wrap gap-3">
            ...
            <Badge className="border border-white/20 bg-red-600 text-white hover:bg-red-600">New premium CX rebuild</Badge>
          </div>
    ...
    <ToyotaLayout activeNavItem="business">
      <div className="min-h-screen bg-[radial-gradient(circle_at_top_left,rgba(239,68,68,0.12),transparent_32%),linear-gradient(180deg,#f9fafb_0%,#ffffff_45%,#f3f4f6_100%)] pb-32 md:pb-16">
        <section className="mx-auto max-w-7xl px-4 py-6 md:px-6 md:py-10">
          <div className="mb-5 flex flex-col gap-3 rounded-[1.5rem] border border-red-100 bg-white/80 p-4 shadow-lg shadow-red-100/40 backdrop-blur md:flex-row md:items-center md:justify-between">
            <div>
              <p className="text-xs font-black uppercase tracking-[0.22em] text-red-600">Recreated premium experience</p>
              <p className="mt-1 text-sm text-gray-600">A fully rebuilt guided B2B journey with live estimate, fleet summary, CRM payload, WhatsApp continuation, and analytics hooks.</p>
            </div>
            <Badge className="w-fit bg-gray-950 text-white hover:bg-gray-950">Business Mobility Builder CX v2</Badge>
          </div>
